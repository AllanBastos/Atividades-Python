...
class GrafoDirecionado:
    ...
    def __init__(self, N=None, M=None):
        ...
        for v in N:
            if not (GrafoDirecionado.vertice_valido(v)):
        ...
        for i in range(len(N)):
            for j in range(len(N)):
                aresta = N[i] + GrafoDirecionado.SEPARADOR_ARESTA + N[j]
    ...
    def aresta_valida(self, aresta=''):
        ...
        if aresta.count(GrafoDirecionado.SEPARADOR_ARESTA) != GrafoDirecionado.QTDE_MAX_SEPARADOR:
            return False

        # Índice do elemento separador
        i_traco = aresta.index(GrafoDirecionado.SEPARADOR_ARESTA)

        # O caractere separador não pode ser o primeiro ou o último caractere da aresta
        if i_traco == 0 or aresta[-1] == GrafoDirecionado.SEPARADOR_ARESTA:
            return False
    ...
    def vertice_valido(self, vertice: str):
        ...
        '''
        return vertice != '' and vertice.count(GrafoDirecionado.SEPARADOR_ARESTA) == 0
    ...
    def existe_vertice(self, vertice: str):
        ...
        '''
        return GrafoDirecionado.vertice_valido(vertice) and self.N.count(vertice) > 0

    def primeiro_vertice_aresta(self, a: str):
        return a[0:a.index(GrafoDirecionado.SEPARADOR_ARESTA)]

    def segundo_vertice_aresta(self, a: str):
        return a[a.index(GrafoDirecionado.SEPARADOR_ARESTA) + 1:]
    ...
    def existe_aresta(self, a: str):
        ...
        '''
        existe = False
        if GrafoDirecionado.aresta_valida(self, a):
